...
$search = $connection->query("SELECT * FROM users WHERE role= 'employee' ");
$search->execute(); // executing the command

$employeelist = $search->fetchall(PDO::FETCH_OBJ); // fetching all of the data as an object
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Employee List</h4>
                    <h6>Manage your Employee list</h6>
                </div>
                <div class="page-btn">
                    <a href="add_employee.php" class="btn btn-added"><img src="<?php echo FILEPATH; ?>/assets/img/icons/plus.svg" alt="img" class="me-1">Add New Employee</a>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table  datanew">
                            ...
                            <tbody>
                                <?php foreach ($employeelist as $employee) : ?><!--Iterating each value from admin list and assigning it to $admin-->
                                    <tr>
                                        ...
                                        <td>
                                            <a class="me-3" data-bs-toggle="modal" data-bs-target="#editProductModal" onclick="update_account('<?php echo $employee->name; ?>', '<?php echo $employee->email; ?>', '<?php echo $employee->id; ?>')">
                                                <img src="<?php echo FILEPATH; ?>/assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a data-bs-toggle="modal" onclick="delete_account(<?php echo $employee->id; ?>);" data-bs-target="#deleteProductModal" data-productid="<?php echo $employee->id; ?>">
