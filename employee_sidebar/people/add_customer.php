            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <h6>Create new Customer account</h6>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" placeholder="email address @customer.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <a href="../employee_index.php" class="btn btn-cancel">Cancel</a> 
                                </div>
                            </div>
                        </div>
                    </div>
