...
<script>
    function openReviewModal(orderId) {
        ...
        $.ajax({
            url: '<?php echo FILEPATH;?>/process/pos_crud/get_order_details.php',
            method: 'POST',
            ...
            success: function(response) {
                ...
                // Store the orderId in a data attribute for later use
                $('#reviewModal').data('orderId', orderId);
    ...
    function validateOrder() {
        ...
        // Implement AJAX call to transfer entries to pending_orders
        $.ajax({
            url: '<?php echo FILEPATH;?>/process/pos_crud/validate_order.php',
            method: 'POST',
            data: {orderId: orderId},
            success: function(response) {
                // Redirect to pos.php upon successful validation
